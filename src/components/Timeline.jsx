  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto pt-10 px-4 md:px-8 lg:px-10">
        <h2 className="text-3xl md:text-6xl font-extrabold mb-6 text-black dark:text-white">
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-32 self-start max-w-xs lg:max-w-sm md:w-full">
              ...
              {/* ✅ BIGGER TITLE */}
              <h3 className="hidden md:block text-3xl md:pl-20 md:text-6xl font-bold text-neutral-400">
                {item.title}
              </h3>
            </div>

            <div className="relative pl-20 pr-4 md:pl-4 w-full">
              <h3 className="md:hidden block text-3xl mb-4 font-bold text-neutral-400">
                {item.title}
              </h3>
              {item.content}
            </div>
